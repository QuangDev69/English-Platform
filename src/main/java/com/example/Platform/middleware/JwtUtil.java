...
public class JwtUtil {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        claims.put("phoneNumber", ((User) userDetails).getPhoneNumber());
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        return ((username.equals(userDetails.getUsername()) || phoneNumber.equals(((User) userDetails).getPhoneNumber())) && !isTokenExpired(token));
    }
}
